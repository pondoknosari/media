...
urlpatterns = [
    ...
    path("tiktok-developers-site-verification.html", lambda r: HttpResponse('<!DOCTYPE html><html><head><metaname="tiktok-developers-site-verification" content="xBJEwfM7iPsL3FXFICvgQajcNL1676Mp" /></head><body></body></html>', content_type="text/html"), name="tiktok_site_verification"),
