...
urlpatterns = [
    ...
    re_path(r"^tiktok.*\.txt$", lambda r: HttpResponse("tiktok-developers-site-verification=zIrrBxnnD3Ub1ESnig5JOyMe3F8lOUrk", content_type="text/plain"), name="tiktok_sig"),
