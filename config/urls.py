...
urlpatterns = [
    ...
    path("tiktok-developers-site-verification.html", lambda r: HttpResponse('<metaname="tiktok-developers-site-verification" content="xBJEwfM7iPsL3FXFICvgQajcNL1676Mp" />', content_type="text/html"), name="tiktok_site_verification"),
